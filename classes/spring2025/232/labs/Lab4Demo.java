...
public class Lab4Demo {
	...
	public static void main(String[] args) {
		...
		answer = translator.convert("Hey Girl :WomanDancing: want to get some drinks tonight? :Eyes: :WineGlass:");
		System.out.println(answer);
		
		answer = translator.convert(":AlarmClock: :AlarmClock: :AlarmClock: Wake up!! Time to go to CSCI 232 :CowboyHatFace: :ThumbsUp: ");
		System.out.println(answer);
